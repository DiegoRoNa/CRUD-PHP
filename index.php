...
<html lang="en">
  ...
  <body>
    ...
    <!-- ########## START: LEFT PANEL ########## -->
    <div class="br-logo"><a href="index.php"><span>[</span>CRUD<span>]</span></a></div>
    <div class="br-sideleft overflow-y-auto">
      ...
      <div class="br-sideleft-menu">
        ...
        <ul class="br-menu-sub nav flex-column">
          <li class="nav-item"><a href="view/MntProducto/" class="nav-link">Producto</a></li>
        </ul>
      </div>
    ...
    <div class="br-mainpanel">
      ...
      <div class="br-pagebody">
        <div class="br-section-wrapper">
            <h1 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">CRUD PHP, MySQL, JS - MVC</h1>
